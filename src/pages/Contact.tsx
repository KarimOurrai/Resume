...
const Contact = () => {
  ...
  return (
    <div
      className={`min-h-screen ${theme === "light" ? "bg-gray-100" : "bg-[#1a1e23]"} pt-24 px-8`}
    >
      <div className='max-w-4xl mx-auto'>
        ...
        <div className='space-y-8'>
          ...
          >
            ...
            <div>
              <span
                className={`text-xl block ${theme === "light" ? "text-gray-900" : "text-white"}`}
              >
                {t("contact.email")}
              </span>
              <span className={theme === "light" ? "text-gray-600" : "text-gray-400"}>
                karim.ourrai@gmail.com
              </span>
            </div>
          </a>
          <a
